...
export const GEYSER_TYPE_NAMES = [
  ...
  { type_id:   254095636, name: "Iron Volcano"            },
  { type_id:  -695301211, name: "Copper Volcano"          },
  { type_id:  -968505972, name: "Aluminum Volcano"        },
  { type_id: -1332060084, name: "Gold Volcano"            },
  { type_id:  1137916511, name: "Cobalt Volcano"          },
  { type_id:   159381264, name: "Tungsten Volcano"        },
  { type_id:   976669543, name: "Niobium Volcano"         },
];
